...
('Matcha Latte', '{"en": "A creamy and frothy blend of matcha green tea and steamed milk, sweetened with a touch of honey.", "fi": "Kermainen ja kuohkea yhdistelmä matcha-vihreää teetä ja höyrytettyä maitoa, makeutettuna hunajalla."}', 4.90, '/img/menu-images/matchalatte.jpg', 'Drinks'),

('Green Tea', '{"en": "A classic, soothing cup of traditional Japanese green tea. Made with finely ground tea leaves. Mild, smooth taste with a subtle earthy flavor.", "fi": "Klassinen, rauhoittava kuppi perinteistä japanilaista vihreää teetä. Valmistettu hienoksi jauhetuista teelehdistä, juomassa on mieto ja sileä maku, jossa on hieno maahinen vivahde."}', 3.90, '/img/menu-images/green-tea.jpg', 'Drinks'),

('Yuzu Lemonade', '{"en": "A refreshing Japanese citrus drink made with yuzu, a tart lemon-like fruit, and lightly sweetened with sugar. Served cold with a splash of soda.", "fi": "Virkistävä japanilainen sitrushedelmäjuoma, jossa on yuzu, kirpeä sitruunamainen hedelmä, ja kevyesti makeutettu sokerilla. Tarjoillaan kylmänä soodan kanssa."}', 3.90, '/img/menu-images/yuzy-lemonade.jpg'),

('Asahi Super Dry', '{"en": "A crisp, refreshing Japanese lager with a clean, dry finish. Known for its smooth taste and perfect balance of bitterness.", "fi": "Raikas ja virkistävä japanilainen lager, jolla on puhdas ja kuiva jälkimaku. Tunnetaan sileästä maustaan ja täydellisestä katkeruuden tasapainosta"}', 6.90, '/img/menu-images/asahi.jpg', 'Drinks'),

('Sapporo Premium Beer', '{"en": "A well-known Japanese lager that has a slightly malty sweetness with a crisp, refreshing finish. Perfect for those who prefer a slightly richer beer.", "fi": "Tunnettu japanilainen lager, jossa on tasapainoinen ja sileä maku. Pieni maltaisen makeus yhdistyy raikkaaseen ja virkistävään jälkimakuun. Täydellinen niille, jotka arvostavat hieman täyteläisempää olutta."}', 7.90, '/img/menu-images/sapporo3.jpg', 'Drinks'), 

('Sake', '{"en": "A traditional Japanese rice wine with a smooth, clean taste and a slightly sweet finish. Served chilled in a small ceramic cup.", "fi": "Perinteinen japanilainen riisiviini, jossa on sileä ja puhdas maku sekä kevyt makea jälkimaku. Tarjoillaan viileänä pienessä keramiikkamukissa."}', 7.90, '/img/menu-images/sake3.jpg', 'Drinks'), 

('Matcha Tiramisu', '{"en": "A Japanese twist on the classic tiramisu, with layers of delicate matcha-flavored cream and soft cake batter soaked in green tea.", "fi": "Japanilainen versio klassisesta tiramisusta, jossa on kerroksia herkullista matcha-kermaa ja pehmeää kakkutaikinaa, joka on kostutettu vihreällä teellä."}', 7.90, '/img/menu-images/match-tiramisu2.jpg', 'Desserts'),

('Yatsuhashi', '{"en": "A traditional Kyoto-style dessert made with cinnamon-flavored rice dough, often filled with sweet red bean paste or matcha.", "fi": "Perinteinen Kioton alueen herkku, joka on valmistettu kanelimaustetusta riisitaikinasta, usein täytettynä makealla punapaputahnalla tai matchalla."}', 5.90, '/img/menu-images/yatsuhashi.jpg', 'Desserts'),

('Shirokama', '{"en": ""A lighter, fluffier version of the traditional cheesecake, with a smooth texture and a subtle sweet flavor. Made with cream cheese and a touch of citrus zest.", "fi": "Keveämpi ja kuohkeampi versio perinteisestä juustokakusta, jossa on sileä rakenne ja miedon makea maku. Valmistettu tuorejuustosta ja ripauksella sitruunankuorta."}', 7.90, 'img/menu-images/cheese-cake.jpg', 'Desserts'), 

('Kohaku Jelly', '{"en": "A delicate and refreshing jelly made from agar, with a layer of red bean paste and sweet syrup. Served chilled, offering a sweet, slightly chewy texture and smooth finish.", "fi": "Herkullinen ja raikas hyytelö, joka on valmistettu agarista, punapaputahnasta ja makeasta siirapista. Tarjoillaan viileänä, tarjoten makean, hieman sitkeän rakenteen ja sileän jälkimaun."}', 5.90, '/img/menu-images/jelly.jpg', 'Desserts'),

('Uji Kintoki', '{"en": ""A sweet, refreshing dessert made with shaved ice topped with sweet red bean paste, syrup, and matcha powder.", "fi": "Makea ja raikas jälkiruoka, joka on valmistettu höylätyllä jäällä, joka on päällystetty makealla punapaputahnalla, siirapilla ja matchajauheella."}', 6.90, '/img/menu-images/uji-kintoki2', 'Desserts'), 

('Black Sesame Cheesecake', '{"en": "A rich and creamy cheesecake infused with the nutty, earthy flavor of roasted black sesame seeds, served with a berry compote.", "fi": "Rikas ja kermaisa juustokakku, joka on maustettu paahdetuilla mustilla seesaminsiemenillä ja tarjoillaan marjahillon kanssa."}', 7.90, '/img/menu-images/sesameseed-cheesecake.jpg', 'Desserts');

-- Insert allergens
INSERT INTO Allergens (menu_id, allergen_description) VALUES 
(1, 'F, M'), (2, 'F'), (3, 'F, G, S'), (4, 'F, G, S'), (5, 'S'), (6, 'F, S'), (7, 'F'), (8, 'E, F, G, S'), (9, 'F, G, S'), 
(10, 'F, M, S'), (11, 'F, G, S'), (12, 'F, G, S'), (13, 'S'), (14, 'S'), (15, 'S'), (16, 'F'), (17, 'F'), (18, 'F'), (19, 'M'), (22, 'G'), (23, 'G'), (25, 'E, G, M'), (26, 'G'), (27, 'E, G, M'), (29, 'S'), (30, 'E, G, M') ;
